        ...
        <el-card class="box-card">
            ...
            <el-table
                ...
                <el-table-column
                        ...
                        align="center">
                    <template slot-scope="scope">
                        <el-button v-has="['SEPP']" icon="el-icon-edit" @click="editResourceConfig(scope.row)"
                                   type="text"
                                   class="oper-button" style="color:#DEAF6C"></el-button>
                        <el-button v-auth="{id:'deleteResource',component:'ResourceConfig'}" icon="el-icon-delete"
                                   @click="deleteResourceConfig(scope.row)" type="text"
                                   class="oper-button"
