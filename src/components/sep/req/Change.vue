<template>
  <div id="root">
    ...
    <div class="change-form">
      <el-form ref="form" :model="changeForm" :inline="true" size="mini" class="plan-form" label-width="110px" @keydown.native.enter="changeAuditQuery()">
        ...
        <el-form-item label="变更用户">
          <el-select v-model="changeForm.changeUser" placeholder="请选择" filterable clearable :filter-method="filterUsers" @visible-change="resetFilterText">
            <el-option-group
      ...
      <el-table :data="tableData" size="mini" :max-height="tableHeight" stripe :border="showBorder" ref="changeTable"
        ...
        <el-table-column prop="auditUserName" label="应确认用户" min-width="20%" align="center" sortable show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="audittedUserName" label="已确认用户" min-width="20%" align="center" sortable show-overflow-tooltip>
        </el-table-column>
