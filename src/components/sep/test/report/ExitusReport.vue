    ...
    <div class="report-content">
      ...
      <div class="sum-info">
        <el-radio-group v-model="result">
          <el-radio label=1 key=1 border :disabled="majorFail || miniFail">测试通过，可进入下一阶段</el-radio>
          <el-radio label=2 key=2 border>测试不通过，不可进入下一阶段</el-radio>
        </el-radio-group>
      </div>
