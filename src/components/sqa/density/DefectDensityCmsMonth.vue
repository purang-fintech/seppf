<template>
  <div id="densityCmsChartsM" style="width: 100%; height: 300px;"></div>
</template>
...
export default {
  ...
  mounted() {
    let _self = this;
    let charts = document.getElementById("densityCmsChartsM");
