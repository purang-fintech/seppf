...
<div ref="root">
  ...
  <el-dialog :close-on-click-modal="modalClose" title="新建 团队信息" :visible.sync="showNewBox" width="500px">
    <el-form :model="newForm" ref="teamFormNew" :rules="teamFormRules" size="small" :inline="false" label-width="100px">
      ...
      <el-form-item label="团队负责人" prop="responser" required>
        <el-select v-model="newForm.responser" placeholder="请选择" filterable clearable class="team-infos" :filter-method="filterUsers" @visible-change="resetFilterText">
          <el-option-group
      ...
      <el-form-item label="团队说明">
        <el-input type="textarea" :rows="8" v-model="newForm.teamDescription" class="team-infos" :maxlength="2000" show-word-limit></el-input>
      </el-form-item>
    </el-form>
    <div slot="footer">
  ...
  <el-dialog :close-on-click-modal="modalClose" title="修改 团队信息" :visible.sync="showModBox" width="500px">
    <el-form :model="modForm" ref="teamFormMod" :rules="teamFormRules" size="small" :inline="false" label-width="100px">
      <el-form-item label="团队名称" prop="teamName" required>
        <el-input v-model="modForm.teamName" placeholder="请输入团队名称，50字以内" clearable class="team-infos"></el-input>
      </el-form-item>
      <el-form-item label="团队负责人" prop="responser" required>
        <el-select v-model="modForm.responser" placeholder="请选择" filterable clearable class="team-infos" :filter-method="filterUsers1" @visible-change="resetFilterText">
          <el-option-group
      ...
      <el-form-item label="团队说明">
        <el-input type="textarea" :rows="8" v-model="modForm.teamDescription" class="team-infos" :maxlength="2000" show-word-limit></el-input>
      </el-form-item>
    </el-form>
    <div slot="footer">
      <el-button v-no-more-click type="primary" icon="el-icon-circle-close" size="small" @click="onCancel">取消</el-button>
  ...
  <el-dialog :close-on-click-modal="modalClose" title="选择团队成员" :visible.sync="currentTeam.showAddMember" width="400px">
    <el-select size="small" v-model="currentTeam.addSelected" placeholder="请选择，可多选" filterable clearable multiple class="team-infos" :filter-method="filterUsers2" @change="multiOptionsHandler">
      <el-option-group
  ...
  <div class="team-detail" v-bind:style="{height: baseHeight + 'px'}"> 
    <el-input type="textarea" :rows="5" v-model="currentTeam.teamDescription" class="team-description" resize="none" disabled></el-input>
    ...
    <el-table :data="currentTeam.members" :max-height="tableHeight" size="middium" stripe style="margin-top:10px" @selection-change="selectionChange" :border="showBorder">
