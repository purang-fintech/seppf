<template>
  <div class="root">
    ...
    <el-card class="product-info" shadow="hover">
      ...
      <el-form ref="pdForm" :rules="prodfromRules" :model="productInfo" :inline="false" size="mini" label-width="110px">
      ...
      <el-form-item label="负责人" prop="owner" required>
        <el-select v-model="productInfo.owner" filterable clearable :filter-method="filterUsers8" @visible-change="resetFilterText":disabled="!editing" style="width:100%">
          <el-option-group
    ...
    <el-card class="product-info" shadow="hover">
      ...
      <el-form :model="configForm" size="small" :inline="false" :rules="configFormRules" ref="configForm" label-width="135px">
        <el-form-item label="产品负责人" prop="pdResponser" required>
          <el-select v-model="configForm.pdResponser" placeholder="请选择" filterable clearable :filter-method="filterUsers1" @visible-change="resetFilterText">
            <el-option-group
        ...
        <el-form-item label="辅助产品负责人" prop="pdAssistant">
          <el-select v-model="configForm.pdAssistant" placeholder="请选择，可多选" filterable clearable multiple :filter-method="filterUsers2" @change="multiOptionsHandler2">
            <el-option-group
        ...
        <el-form-item label="开发负责人" prop="devResponser" required>
          <el-select v-model="configForm.devResponser" placeholder="请选择" filterable clearable :filter-method="filterUsers3" @visible-change="resetFilterText">
            <el-option-group
        ...
        <el-form-item label="辅助开发负责人" prop="devAssistant">
          <el-select v-model="configForm.devAssistant" placeholder="请选择，可多选" filterable clearable multiple :filter-method="filterUsers4" @change="multiOptionsHandler4">
            <el-option-group
        ...
        <el-form-item label="测试负责人" prop="testResponser" required>
          <el-select v-model="configForm.testResponser" placeholder="请选择" filterable clearable :filter-method="filterUsers5" @visible-change="resetFilterText">
            <el-option-group
        ...
        <el-form-item label="辅助测试负责人" prop="testAssistant">
          <el-select v-model="configForm.testAssistant" placeholder="请选择，可多选" filterable clearable multiple :filter-method="filterUsers6" @change="multiOptionsHandler6">
            <el-option-group
    ...
    <el-card class="product-info" shadow="hover">
      ...
      <el-form :model="configForm" size="small" :inline="false" label-width="200px" style="margin-top:10px" class="gompertz-define">
        <el-form-item>
          <template slot="label">
