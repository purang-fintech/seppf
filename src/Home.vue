  ...
  <div class="wrapper">
    ...
    <div class="header">
      ...
      <div class="user-info">
        ...
        <el-button v-no-more-click class="full-screen">
          <el-tooltip content="全屏浏览" effect="dark" placement="left">
            <i @click="toFullScreen()" v-show="fullScreen==false" class="el-icon-full-screen"></i>
          </el-tooltip>
          <el-tooltip content="退出全屏" effect="dark" placement="left">
            <i @click="exitFullScreen()" v-show="fullScreen==true" class="el-icon-bottom-left"></i>
          </el-tooltip>
        </el-button>
